...
class CodegenLoader extends AssetLoader{
  ...
  static const Map<String,dynamic> _ps_AF = {
  "greeting": "سلام",
  "thank_you": "مننه"
};
static const Map<String,dynamic> _zh_CN = {
  ...
  "footer": {
    ...
    "downloadsoft": "客户端下载",
    "ios": "@:ios.downloadtab",
    "android": "@:android.downloadtab",
    "windows": "@:windows.downloadtab",
    "macos": "@:macos.downloadtab",
    "linux": "@:linux.downloadtab",
    "aboutuse": "关于使用",
    "faq": "常见问题",
    "help": "帮助中心",
    "payment": "会员价格",
    ...
    "officalcontect": "官方微博",
    "gitlose": "防失联",
    "footest": "© 2025 YourCompany Inc. 保留所有权利"
  },
  "payment": {
    "title": "购买",
    "bigtitle": "飞猪会员订阅",
...
static const Map<String,dynamic> _ru_RU = {
  "general": {
    "title": "Flying Pig VPN",
    "greylaw": "Greylaw",
    "greyblue": "Greyblue",
    "blue": "Blue",
    "green": "Green",
    "greenmoney": "Darkgreen",
    "red": "Redwine",
    "purple": "Purple",
    "redwine": "Redwine",
    "gold": "Gold",
...
static const Map<String, Map<String,dynamic>> mapLocales = {"ps_AF": _ps_AF, "zh_CN": _zh_CN, "fa_IR": _fa_IR, "ru_RU": _ru_RU, "en_US": _en_US};
}
